...
export const closePopupButton = document.querySelector('.popup__close-button_profile');
export const profileTitle = document.querySelector('.profile__title');
export const profileSubtitle = document.querySelector('.profile__subtitle');
export const inputTitle = document.querySelector('.popup__input_profile_name');
export const inputSubtitle = document.querySelector('.popup__input_profile_job');
...
export const closePopupAddButton = document.querySelector('.popup__close-button_card');
...
export const buttonSubmitEditFormAdd = document.querySelector('.popup__close-button_card');
...
export const cardDeleteButton = cardElement.querySelector('.elements__delete-button');
...
export const popupFullImageItem = document.querySelector('.popup__image-opened');
